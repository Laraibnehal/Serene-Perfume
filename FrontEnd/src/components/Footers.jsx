...
<a href='https://www.instagram.com/___serene.__/' target='_blank' rel='noreferrer'><FaInstagram className="relative cursor-pointer text-xl text-white"/></a>

</div>
<div className='flex relative  cursor-pointer text-2xl'>
<div className='p-3 rounded-3xl border-2 border-white'>
<a href="https://www.facebook.com/profile.php?id=100079662549115" target='_blank' rel='noreferrer'><FaFacebook className="relative cursor-pointer text-xl text-white"/></a>
</div>
</div>
</div>
</div>
